...
<?php
	...
	echo'<div class="rounded col-10 mb-3 mt-5" ><p>
	<a href="readmore.php?job='.$row["id"].'"  class="small">'.$row["job_title"].'</a></p>';

	
	echo '<a target="_blank"  class="btn btn-primary mr-2 ml-2" href="https://www.bing.com/indexnow?url=http://www.jobsagent.org/readmore.php?job='.$row['id'].'&key=5b30d22fd91b4e469a8326c053b64713">Bing AR Submit </a>';
	echo '<a target="_blank" class="btn btn-danger mr-2 ml-2"  href="https://www.bing.com/indexnow?url=http://www.english.jobsagent.org/readmore.php?job='.$row['id'].'&key=5b30d22fd91b4e469a8326c053b64713">Bing  EN Submit </a>';
echo'</div>';
